...
Acad.ErrorStatus = {
    "eJsOk": 0,
    "eJsFail": 1,
    "eJsUnknownError": // Native wrapper function return error
    2,
    "eJsInvalidInputJsonArgs": // Unknown error
    3,
    "eJsUnSupportedSysVarValueType": // Invalid arguments passed in JSON
    4,
    "eJsUnknownCallback": // Unsupported sysvar value type
    5,
    "eJsInvalidTooltipId": // Unknown callback name
    6,
    "eJsUnknownFunctionName": // Invalid Tooltip Id
    7,
    "eJsUnknownCompleteCallback": // Unknown function name passed to exec
    8,
    "eJsUnknownErrorCallback": // Unknown onComplete callback passed to execAsync
    9,
    "eJsNoDocument": // Unknown onError callback passed to execAsync
    10,
    "eJsSyncFunction": // No current document
    11,
    "eJsAsyncFunction": // Synchronous function being called asynchronously
    12,
    "eJsFailGetCurGsView": // Asynchronous function being called synchronously
    13,
    "eJsFailGetSysVar": // Null AcGsView
    14,
    "eJsFailGetDrawable": // Null AcDiSysVar
    15,
    "eJsFailCreateJig": // Null AcJsDrawable
    16,
    "eJsJigPromptSet": // Failed to create a new instance of jig
    17,
    "eJsNotSupportedInPaperSpace": // Jig prompt option has already been set
    18,
    "eJsCommandLineBusy": // Not supported in Paper Space
    19,
    "eJsNotAvailableInLockedViewport": // Waiting for previous command to finish execution
    20
};
// View change not available in locked viewprot.
/*
...
Acad.Editor.CurrentViewport = new function () {
    ...
    */
    this.setView = function (position, target, upVector, fieldWidth, fieldHeight, projection, animate) {
        ...
        var jsonResponse = exec(JSON.stringify(args));
        var jsonObj = JSON.parse(jsonResponse);
        if((jsonObj.retCode !== Acad.ErrorStatus.eJsOk) && (jsonObj.retCode !== Acad.ErrorStatus.eJsNotAvailableInLockedViewport)) {
            throw Error(jsonObj.retErrorString);
        }
    };
    /**
    ...
    */
    ...
    /**
    * Rotates the cameraï¿½s up vector about the eye vector by the specified amount in radians. Positive angles correspond to a clockwise rotation when viewed from the camera position to the camera target
